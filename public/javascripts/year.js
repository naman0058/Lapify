...
$('#update').click(function(){  //data insert in database
    ...
    $.post(`/admin/year/update`, updateobj , function(data) {
       update()
...
function refresh() 
{
    $.getJSON(`/admin/year/all`, data => makeTable(data))
}
function update()
{
    $('#result').show()
